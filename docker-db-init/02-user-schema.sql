...
CREATE INDEX IF NOT EXISTS idx_hash_user_username ON "user" USING HASH(username);
CREATE INDEX IF NOT EXISTS idx_hash_user_email ON "user" USING HASH(email);
CREATE INDEX IF NOT EXISTS idx_hash_user_keycloak_id ON "user" USING HASH(keycloak_id);